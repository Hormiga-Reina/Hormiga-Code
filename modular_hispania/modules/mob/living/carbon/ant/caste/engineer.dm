/mob/living/carbon/ant/engineer
	name = "alien hunter"
	caste = "h"
	maxHealth = 125
	health = 125
...
/mob/living/carbon/ant/engineer/Initialize(mapload)
	. = ..()
	if(name == "ant")
		name = "ant ([rand(1, 1000)])"
	real_name = name

/mob/living/carbon/ant/engineer/get_caste_organs()
	. = ..()
	. += /obj/item/organ/internal/alien/plasmavessel/hunter


/mob/living/carbon/ant/engineer/handle_environment()
...
/*REMOVER LUEGO, LAS HORMIGAS OBRERAS NO PODRÁN SALTAR*/
/mob/living/carbon/ant/engineer/proc/toggle_leap(message = 1)
...
/mob/living/carbon/ant/engineer/ClickOn(atom/A, params)
	face_atom(A)
	if(leap_on_click)
		leap_at(A)
	else
...
/mob/living/carbon/ant/engineer/proc/leap_at(atom/A)
...
/mob/living/carbon/ant/engineer/proc/leap_end()
	leaping = 0
	update_icons()

/mob/living/carbon/ant/engineer/throw_impact(atom/A)
	if(!leaping)
		return ..()
...
/mob/living/carbon/ant/engineer/float(on)
	if(leaping)
		return
	..()

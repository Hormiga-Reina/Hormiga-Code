...
/obj/item/organ/internal/ant/insert(mob/living/carbon/M, special = 0)
	..()
	for(var/powers_to_add in alien_powers)
		M.AddSpell(new powers_to_add)

/obj/item/organ/internal/ant/remove(mob/living/carbon/M, special = 0)
	for(var/powers_to_remove in alien_powers)
		M.RemoveSpell(new powers_to_remove)
	. = ..()

/obj/item/organ/internal/ant/prepare_eat()
	var/obj/S = ..()
...
/obj/item/organ/internal/ant/plasmavessel
...
/obj/item/organ/internal/ant/plasmavessel/prepare_eat()
	var/obj/S = ..()
	S.reagents.add_reagent("plasma", stored_plasma/10)
	return S

/obj/item/organ/internal/ant/plasmavessel/queen
...
/obj/item/organ/internal/ant/plasmavessel/drone
	name = "large xeno plasma vessel"
	icon_state = "plasma_large"
	stored_plasma = 200
	max_plasma = 500

/obj/item/organ/internal/ant/plasmavessel/sentinel
	stored_plasma = 100
	max_plasma = 250

/obj/item/organ/internal/ant/plasmavessel/hunter
...
/obj/item/organ/internal/ant/plasmavessel/larva
...
/obj/item/organ/internal/ant/plasmavessel/on_life()
...
/obj/item/organ/internal/ant/plasmavessel/insert(mob/living/carbon/M, special = 0)
	..()
	M.update_plasma_display(M)

/obj/item/organ/internal/ant/plasmavessel/remove(mob/living/carbon/M, special = 0)
	. =..()
	M.update_plasma_display(M)

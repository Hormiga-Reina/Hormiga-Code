...
/mob/living/carbon/ant/worker/Initialize(mapload)
	. = ..()
	if(name == "ant")
		name = "ant ([rand(1, 1000)])"
	real_name = name

/mob/living/carbon/ant/worker/get_caste_organs()
	. = ..()
	. += /obj/item/organ/internal/alien/plasmavessel/hunter


/mob/living/carbon/ant/worker/handle_environment()
...
/mob/living/carbon/ant/worker/proc/toggle_leap(message = 1)
...
/mob/living/carbon/ant/worker/ClickOn(atom/A, params)
	face_atom(A)
	if(leap_on_click)
		leap_at(A)
	else
...
/mob/living/carbon/ant/worker/proc/leap_at(atom/A)
...
/mob/living/carbon/ant/worker/proc/leap_end()
	leaping = 0
	update_icons()

/mob/living/carbon/ant/worker/throw_impact(atom/A)
	if(!leaping)
		return ..()
...
/mob/living/carbon/ant/worker/float(on)
	if(leaping)
		return
	..()
